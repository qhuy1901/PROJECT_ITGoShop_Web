			  ...
			  <nav class="navigation">
				<div class="container-fluid">
				  <div class="navigation__column left">
					<div class="header__logo"><a class="ps-logo" href="product-detail.html"><img src="images/logo.png" alt=""></a></div>
				  </div>
              ...
              <div class="ps-cart-listing ps-table--compare">
                <table class="table ps-cart__table">
                  <tbody>
                    <tr>
                      <td>Sản phẩm</td>
                      <td><a class="ps-product__preview text-uppercase" href="product-detail.html"><img class="mr-15" src="./Images/00_Product/Laptop/Apple MacBook Pro 13 2020 - Sự cải thiện bàn phím từ Apple_ Phân phối tại cửa hàng ThinkPro.png" alt=""> Macbook Pro 13</a></td>
                      <td><a class="ps-product__preview text-uppercase" href="product-detail.html"><img class="mr-15" src="./Images/00_Product/Laptop/MSI Modern 15 AMD A5M 2021 _ Ultrabook phổ thông giá với thiết kế đẹp đi kèm với cấu hình rất tốt.png" alt=""> MSI 15 AMD</a></td>
                    </tr>
                    <tr>
                      <td>Giá</td>
