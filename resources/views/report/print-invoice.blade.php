            ...
            <div class="col-md-10">
                <div class="receipt bg-white p-5 rounded">
                    ...
                    <div class="d-flex flex-row justify-content-between align-items-center order-details">
                        <div>
                            <span class="d-block fs-14">Ngày Đặt Hàng</span>
                            <span class="font-weight-bold">07/12/2021</span>
                        </div>
                        <div>
                        ...
                        <div class="col-md-6">
                            <div class="billing">
                                ...
                                <div class="d-flex justify-content-between mt-2"><span
                                        ...
                                        class="font-weight-bold text-success">-0 ₫</span></div>
                                <hr>
                    ...
                    <br>
                    <span class="d-block">Thời Gian Giao Hàng Dự Kiến</span>
                    <span class="font-weight-bold text-success">7 - 10 ngày</span>
                    <span class="d-block mt-3 text-black-50 fs-15">Vui lòng kiểm hàng thật kỹ trước khi thanh toán!</span>
                    <hr>
                    <div class="d-flex justify-content-between align-items-center footer">
                        <div class="thanks">
                            <span class="d-block font-weight-bold">Cảm ơn quý khách đã tin tưởng và mua hàng tại ITGoShop!</span>
                        </div>
                        <div class="d-flex flex-column justify-content-end align-items-end">
                            <span class="d-block font-weight-bold">Đội Ngũ ITGo</span>
                        </div>
                    </div>
                </div>
            </div>
