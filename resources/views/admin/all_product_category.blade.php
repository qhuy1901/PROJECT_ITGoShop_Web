				...
				<div class="page-inner">
					<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="#">Liệt kê danh mục sản phẩm</a>
							</li>
						</ul>
					</div>
					<div class="row">
												...
												<tr>
													...
													<td>
														...
														?>	
																...
																<a href="{{URL::to('/unactive-product-category/'.$pro_category->id)}}"><span class="fa-thumb-styling fa fa-eye" style="font-size:18px"></span></a>
														<?php
															}else{
														?>	
																<a href="{{URL::to('/active-product-category/'.$pro_category->id)}}"><span class="fa-thumb-styling fa fa-eye-slash" style="color:red; font-size:18px"></span></a>
														<?php
															}
														?>
													</td>
