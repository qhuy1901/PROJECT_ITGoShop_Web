...
@section('title', 'Dashboard - Hệ thống Admin')
								...
								<div class="card-header">
									<div class="card-head-row">
										...
										<div class="card-tools">
											...
											<a target="_blank" rel="noopener noreferrer" id="print-customer-report" href="{{URL::to('/print-customer-report')}}" class="btn btn-info btn-border btn-round btn-sm">
												<span class="btn-label">
													<i class="fa fa-print"></i>
												</span>
			...
			else
			{
				$.ajax({
					...
					success:function(data)
					{
						...
						var newCustomerURL = "{{URL::to('/print-customer-report/tu-ngay/den-ngay')}}";
						newCustomerURL = newCustomerURL.replace('tu-ngay', tu_ngay);
						newCustomerURL = newCustomerURL.replace('den-ngay', den_ngay);
						$('#print-customer-report').attr("href", newCustomerURL);
					},
					error:function(data)
					{
						swal({
