                                                        ...
                                                        <td>
                                                            <div class="form-button-action">
																...
																<!-- Chú ý: https://fontawesome.com/v5.15/icons/eye?style=solid icon này lấy ở đây -->
																	<button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Hiển thị phương thức vận chuyển">
																		<span class="fa-thumb-styling fa fa-eye" style="font-size:18px"></span>
																	</button>	
																	<button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Ẩn phương thức vận chuyển" hidden>
	...
	<script>
		$(document).ready(function(){
			$('button[data-original-title="Hiển thị phương thức vận chuyển"]').click(function(){
				...
				$.ajax({
					url: '{{URL::to('/unactive-shipmethod')}}',
					method:"GET",
