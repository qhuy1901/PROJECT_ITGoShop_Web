											...
											<tbody>
												...
												<tr>
													...
													<td>
														...
														<a onclick="return confirm('Bạn cho chắc muốn xóa sản phẩm này không?')" href="{{URL::to('/delete-product-category/'.$product->product_id)}}" class="active" ui-toggle-class="">
